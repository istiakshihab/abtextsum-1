...
# path to x, y, vocabulary etc.
train_data_dir = train_dir + 'train_{}_data/'.format(model_id)
...
train_mydata_article_file_path = train_dir + 'train_mydata_articles.txt'
train_mydata_title_file_path = train_dir+'train_mydata_titles.txt'

train_baselinegigaword_article_file_path = train_dir + \
    'train_baselinegigaword_article.txt'
train_baselinegigaword_title_file_path = train_dir + \
    'train_baselinegigaword_title.txt'
train_neg100gigaword_article_file_path = train_dir + \
    'train_neg100gigaword_article.txt'
train_neg100gigaword_title_file_path = train_dir + 'train_neg100gigaword_title.txt'
train_neg200gigaword_article_file_path = train_dir + \
    'train_neg200gigaword_article.txt'
train_neg200gigaword_title_file_path = train_dir + 'train_neg200gigaword_title.txt'
train_neg500gigaword_article_file_path = train_dir + \
    'train_neg500gigaword_article.txt'
train_neg500gigaword_title_file_path = train_dir + 'train_neg500gigaword_title.txt'
train_neg1000gigaword_article_file_path = train_dir + \
    'train_neg1000gigaword_article.txt'
train_neg1000gigaword_title_file_path = train_dir + \
    'train_neg1000gigaword_title.txt'
train_negAllgigaword_article_file_path = train_dir + \
    'train_negAllgigaword_article.txt'
train_negAllgigaword_title_file_path = train_dir + 'train_negAllgigaword_title.txt'
train_lg100d5gigaword_article_file_path = train_dir + \
    'train_lg100d5gigaword_article.txt'  # generalized word_freq=100, min_depth=5
train_lg100d5gigaword_title_file_path = train_dir + \
    'train_lg100d5gigaword_title.txt'
train_lg200d5gigaword_article_file_path = train_dir + \
    'train_lg200d5gigaword_article.txt'  # generalized word_freq=200, min_depth=5
train_lg200d5gigaword_title_file_path = train_dir + \
    'train_lg200d5gigaword_title.txt'
train_lg500d5gigaword_article_file_path = train_dir + \
    'train_lg500d5gigaword_article.txt'  # generalized word_freq=500, min_depth=5
train_lg500d5gigaword_title_file_path = train_dir + \
    'train_lg500d5gigaword_title.txt'
train_lg1000d5gigaword_article_file_path = train_dir + \
    'train_lg1000d5gigaword_article.txt'
train_lg1000d5gigaword_title_file_path = train_dir + \
    'train_lg1000d5gigaword_title.txt'
train_lgAlld5gigaword_article_file_path = train_dir + \
    'train_lgAlld5gigaword_article.txt'
train_lgAlld5gigaword_title_file_path = train_dir + \
    'train_lgAlld5gigaword_title.txt'
...
# path to x, y, vocabulary etc.
validation_data_dir = validation_dir + '{}/'.format(model_id)

validation_mydata_article_file_path = validation_dir + \
    'validation_mydata_articles.txt'
validation_mydata_title_file_path = validation_dir + 'validation_mydata_titles.txt'

validation_baselinegigaword_article_file_path = validation_dir + \
    'validation_baselinegigaword_articles.txt'
validation_baselinegigaword_title_file_path = validation_dir + \
    'validation_baselinegigaword_titles.txt'

validation_neg100gigaword_article_file_path = validation_dir + \
    'validation_neg100gigaword_articles.txt'
validation_neg100gigaword_title_file_path = validation_dir + \
    'validation_neg100gigaword_titles.txt'
validation_neg200gigaword_article_file_path = validation_dir + \
    'validation_neg200gigaword_articles.txt'
validation_neg200gigaword_title_file_path = validation_dir + \
    'validation_neg200gigaword_titles.txt'
validation_neg500gigaword_article_file_path = validation_dir + \
    'validation_neg500gigaword_articles.txt'
validation_neg500gigaword_title_file_path = validation_dir + \
    'validation_neg500gigaword_titles.txt'
validation_neg1000gigaword_article_file_path = validation_dir + \
    'validation_neg1000gigaword_articles.txt'
validation_neg1000gigaword_title_file_path = validation_dir + \
    'validation_neg1000gigaword_titles.txt'
validation_negAllgigaword_article_file_path = validation_dir + \
    'validation_negAllgigaword_articles.txt'
validation_negAllgigaword_title_file_path = validation_dir + \
    'validation_negAllgigaword_titles.txt'
validation_lg100d5gigaword_article_file_path = validation_dir + \
    'validation_lg100d5gigaword_articles.txt'
validation_lg100d5gigaword_title_file_path = validation_dir + \
    'validation_lg100d5gigaword_titles.txt'
validation_lg200d5gigaword_article_file_path = validation_dir + \
    'validation_lg200d5gigaword_articles.txt'
validation_lg200d5gigaword_title_file_path = validation_dir + \
    'validation_lg200d5gigaword_titles.txt'
validation_lg500d5gigaword_article_file_path = validation_dir + \
    'validation_lg500d5gigaword_articles.txt'
validation_lg500d5gigaword_title_file_path = validation_dir + \
    'validation_lg500d5gigaword_titles.txt'
validation_lg1000d5gigaword_article_file_path = validation_dir + \
    'validation_lg1000d5gigaword_articles.txt'
validation_lg1000d5gigaword_title_file_path = validation_dir + \
    'validation_lg1000d5gigaword_titles.txt'
validation_lgAlld5gigaword_article_file_path = validation_dir + \
    'validation_lgAlld5gigaword_articles.txt'
validation_lgAlld5gigaword_title_file_path = validation_dir + \
    'validation_lgAlld5gigaword_titles.txt'

validation_system_summaries_dir = validation_data_dir + \
    'validation_system_summaries/'
...
validation_rouge_system_summaries_dir = validation_data_dir + \
    'rouge_files/rouge_system_summaries'
validation_rouge_model_summaries_dir = validation_data_dir + \
    'rouge_files/rouge_model_summaries'

validation_article_file_path = validation_dir + \
    'validation_{}_articles.txt'.format(model_id)
validation_summary_file_path = validation_dir + \
    'validation_{}_titles.txt'.format(model_id)

# testing files
test_dir = dataset_dir + 'test/'  # path to initial train files
# path to x, y, vocabulary etc.
test_data_dir = test_dir + '{}/'.format(model_id)
...
test_mydata_article_file_path = test_dir + 'test_mydata_articles.txt'
test_mydata_title_file_path = test_dir + 'test_mydata_titles.txt'

test_baselinegigaword_article_file_path = test_dir + \
    'test_baselinegigaword_articles.txt'
test_baselinegigaword_title_file_path = test_dir + \
    'test_baselinegigaword_titles.txt'


test_neg100gigaword_article_file_path = test_dir + \
    'test_neg100gigaword_articles.txt'  # min_norm_freq=0.8
test_neg100gigaword_title_file_path = test_dir + 'test_neg100gigaword_titles.txt'
test_neg200gigaword_article_file_path = test_dir + \
    'test_neg200gigaword_articles.txt'
test_neg200gigaword_title_file_path = test_dir + 'test_neg200gigaword_titles.txt'
test_neg500gigaword_article_file_path = test_dir + \
    'test_neg500gigaword_articles.txt'
test_neg500gigaword_title_file_path = test_dir + 'test_neg500gigaword_titles.txt'
test_neg1000gigaword_article_file_path = test_dir + \
    'test_neg1000gigaword_articles.txt'
test_neg1000gigaword_title_file_path = test_dir + 'test_neg1000gigaword_titles.txt'
test_negAllgigaword_article_file_path = test_dir + \
    'test_negAllgigaword_articles.txt'
test_negAllgigaword_title_file_path = test_dir + 'test_negAllgigaword_titles.txt'
test_neg100d5gigaword_article_file_path = test_dir + \
    'test_neg100d5gigaword_articles.txt'
test_neg100d5gigaword_title_file_path = test_dir + \
    'test_neg100d5gigaword_titles.txt'
test_neg200d5gigaword_article_file_path = test_dir + \
    'test_neg200d5gigaword_articles.txt'
test_neg200d5gigaword_title_file_path = test_dir + \
    'test_neg200d5gigaword_titles.txt'
test_neg500d5gigaword_article_file_path = test_dir + \
    'test_neg500d5gigaword_articles.txt'
test_neg500d5gigaword_title_file_path = test_dir + \
    'test_neg500d5gigaword_titles.txt'
test_neg1000d5gigaword_article_file_path = test_dir + \
    'test_neg1000d5gigaword_articles.txt'
test_neg1000d5gigaword_title_file_path = test_dir + \
    'test_neg1000d5gigaword_titles.txt'
test_negAlld5gigaword_article_file_path = test_dir + \
    'test_negAlld5gigaword_articles.txt'
test_negAlld5gigaword_title_file_path = test_dir + \
    'test_negAlld5gigaword_titles.txt'
...
# path to x, y, vocabulary etc.
test_duc_data_dir = test_duc_dir + '{}/'.format(duc_model_id)
...
test_duc_article_file_path = test_duc_dir + \
    'test_{}_articles.txt'.format(duc_model_id)
...
test_lg100d5duc_article_file_path = test_duc_dir + \
    'test_lg100d5duc_articles.txt'  # generalized freq=50, min_depth=5
...
test_article_file_path = test_dir + \
    'test_subset_{}_articles.txt'.format(model_id)
test_summary_file_path = test_dir + \
    'test_subset_{}_titles.txt'.format(model_id)
